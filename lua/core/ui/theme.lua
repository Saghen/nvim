	...
	-- color scheme
	{
		...
		opts = {
			...
			highlights = {
				...
				-- Obsidian
				['@text.title.1.markdown'] = { fg = '$blue', fmt = 'bold' },
				['@text.title.2.markdown'] = { fg = '$green', fmt = 'bold' },
				['@text.title.3.markdown'] = { fg = '$red', fmt = 'bold' },
				['@text.title.1.marker.markdown'] = { fg = '$blue', fmt = 'bold' },
				['@text.title.2.marker.markdown'] = { fg = '$green', fmt = 'bold' },
				['@text.title.3.marker.markdown'] = { fg = '$red', fmt = 'bold' },
				ObsidianTag = { fg = '$blue', fmt = 'italic' },
				ObsidianTodo = { fg = '$fg' },
				ObsidianInProgress = { fg = '$yellow' },
				ObsidianDone = { fg = '$blue' },
				ObsidianCancelled = { fg = '$red' },
				ObsidianExtLinkIcon = { fg = '$blue', bg = 'NONE' },
				ObsidianRefText = { fg = '$blue', underline = '$blue', fmt = 'underline' },
				Headline1 = { bg = '$dark_bg_blue' },
				Headline2 = { bg = '$dark_bg_green' },
				Headline3 = { bg = '$dark_bg_red' },

				copilot_enabled = { fg = '$green' },
